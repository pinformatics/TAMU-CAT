Rails.application.routes.draw do
  ...
  get "reports/overview_and_user_guide.pdf", to: "reports#overview_and_user_guide", as: :reports_overview_and_user_guide
  get "reports/example_reports.pdf", to: "reports#example_reports", as: :reports_example_reports
  ...
  namespace :advisors do
    ...
    resources :meeting_recaps, only: %i[index]
